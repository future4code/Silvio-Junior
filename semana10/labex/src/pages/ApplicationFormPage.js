    ...
    return(
        <MainContainerForm>
            <CardForm>
                ...
                <DivSecundaria>
                    <DivInfos>
                        <input value={name} onChange={onChangeName} placeholder="Nome" />
                        <input value={age} onChange={onChangeAge} placeholder="Idade" />
                        <input value={profession} onChange={onChangeProfession} placeholder="Profissão" />
                        ...
                        <select value={tripId} onChange={onChangeTripId}>
                    ...
                    <DivMensagemEnvar>
                        ...
                        <input value={applicationText} onChange={onChangeText} placeholder="Mensagem" />
                        <button onClick={onClickCadidatar}>Enviar Candidatura</button>
                    </DivMensagemEnvar>
